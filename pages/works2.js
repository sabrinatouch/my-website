    ...
    return (
      <Section delay={0.2}>
        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={4}>
          ...
          <WorkItem2 id="khmerconference" href="/works/cambodianlogo" thumbnail="/tb-cambodianlogo.png" title="KRNC" subtitle="Khmer Conference" description="Graphic Design" year="2024" />
        </SimpleGrid>
      </Section>
    )
}
